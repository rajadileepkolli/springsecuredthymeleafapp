...
public class CachingCart extends Cart {
    ...
    Cache getCache() {
        ...
        ApplicationContext context =
                RequestContextUtils.findWebApplicationContext(attributes.getRequest());
     ...
     *
     * @param action The main Processing
     * @param save After the processing , whether you want to save in the cache
     */
