...
public class RoleController {
    ...
    public String createRole(
        ...
        try {
            ...
            log.debug(
                    "Created new role with id : {} and name : {}",
                    persistedRole.getId(),
                    persistedRole.getRoleName());
            redirectAttributes.addFlashAttribute(
                    "success", "Role " + persistedRole.getRoleName() + " created successfully");
        } catch (SecuredAppException e) {
            model.addAttribute("errorMessage", e.getMessage());
            redirectAttributes.addFlashAttribute(
                    "error", "Role " + role.getRoleName() + " was not created");
    ...
    public String updateRole(
        ...
        try {
            ...
            log.debug(
                    "Updated role with id : {} and name : {}",
                    persistedRole.getId(),
                    persistedRole.getRoleName());
            redirectAttributes.addFlashAttribute(
                    "success", "Role updated successfully for " + persistedRole.getRoleName());
        } catch (SecuredAppException e) {
            model.addAttribute("errorMessage", e.getMessage());
